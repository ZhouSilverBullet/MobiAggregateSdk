 ...
 * @Dec csj wrapper
 */
public class NativeExpressAdWrapper extends BaseAdWrapper implements IAdView, TTAdNative.NativeExpressAdListener, TTNativeExpressAd.ExpressAdInteractionListener, TTAppDownloadListener {
