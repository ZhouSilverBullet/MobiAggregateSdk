...
import com.mobi.unityads.wrapper.FullScreenVideoAdWrapper;
import com.mobi.unityads.wrapper.InterstitialADWrapper;
import com.mobi.unityads.wrapper.NativeExpressAdWrapper;
import com.mobi.unityads.wrapper.RewardVideoAdWrapper;
import com.mobi.unityads.wrapper.SplashAdWrapper;
...
public class UnityProvider extends BaseAdProvider {
    ...
    public UnityProvider(String providerType) {
        super(providerType);
    }
